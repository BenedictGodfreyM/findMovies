...
export class AiringTodayComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.getTVShowsAiringToday();
  }

  public getTVShowsAiringToday(page: string = "1"): void{
    this.ui.showSpinner();
    this.tv.airing_today(page)
